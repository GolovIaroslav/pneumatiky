...
<head>
	...
	<title>PneuShop – Dodacie údaje</title>
		...
		<div class="max-w-3xl mx-auto">
			...
			<form action="#" method="post" class="space-y-8">
				...
				<div class="pt-2 flex items-center justify-between gap-4">
					...
					<a href="{{ route('confirmation') }}" class="px-8 py-3 bg-gray-600 hover:bg-gray-700 text-white font-medium rounded-full transition-colors">Dokončiť objednávku</a>
				</div>
			</form>
		</div>
