...
<head>
  ...
  <title>PneuShop – Doprava a spôsob platby</title>
...
<body class="font-sans bg-white text-gray-900 text-sm">
  ...
  <main class="max-w-6xl mx-auto px-6 py-10 min-h-[60vh]">
    ...
    <div class="text-right text-lg mb-2">Cena produktov: 499,95 €</div>
    <div class="text-right font-bold text-lg mb-8">Celková cena: 501,24 €</div>
